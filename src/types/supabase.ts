  ...
  public: {
    Tables: {
      ...
      tournament_disputes: {
        ...
        Relationships: [
          {
            foreignKeyName: "tournament_disputes_course_id_fkey"
            columns: ["course_id"]
            isOneToOne: false
            referencedRelation: "courses"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "tournament_disputes_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "golfer_profiles"
            referencedColumns: ["user_id"]
          ...
          },
          {
            ...
            columns: ["round_id"]
            isOneToOne: false
            referencedRelation: "tournament_leaderboard_dense_rank"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "tournament_disputes_round_id_fkey"
            columns: ["round_id"]
            isOneToOne: false
            referencedRelation: "tournament_leaderboard_gapped_rank"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "tournament_disputes_round_id_fkey"
    ...
    Views: {
      ...
      tournament_disputes_with_details: {
        Row: {
          admin_notes: string | null
          created_at: string | null
          first_name: string | null
